...
if __name__ == "__main__":
    ...
    print(f"Persisted volume claim name: {environment.persisted_volume.claim_name}")

    with Workflow(generate_name="test-volume-claim-", entrypoint="main") as w:
        with DAG(name="main"):
            t1 = does_the_mounted_appear_in_list(
                arguments=[
                    Parameter(
